export const buttonShortcuts: Record<string, string> = {
  'a-button-base':
    `flex justify-center gap1 items-center m0 inline-flex rounded-lg box-border border after:display-none a-transition
     dark:bg-op80 dark:border-op80 dark:text-op80`,
